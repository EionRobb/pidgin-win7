...
pidgin_win7_add_tasks(ICustomDestinationList *pcdl, IObjectCollection *shellLinks)
{
	...
	if (SUCCEEDED(hr))
	{
		...
		shellLink = pidgin_win7_create_shell_link(_("New _Message..."), iconpath, 5, pidgin_path, "--protocolhandler=win7:open?window=im", NULL);
		shellLinks->lpVtbl->AddObject(shellLinks, (IUnknown *)shellLink);
		shellLink->lpVtbl->Release(shellLink);
		
		shellLink = pidgin_win7_create_shell_link(_("Join Chat..."), iconpath, 6, pidgin_path, "--protocolhandler=win7:open?window=chat", NULL);
		shellLinks->lpVtbl->AddObject(shellLinks, (IUnknown *)shellLink);
		shellLink->lpVtbl->Release(shellLink);
...
/*****************************************************************************/
		...
		shellLink = pidgin_win7_create_shell_link(_("Plu_gins"), iconpath, 7, pidgin_path, "--protocolhandler=win7:open?window=plugins", NULL);
		shellLinks->lpVtbl->AddObject(shellLinks, (IUnknown *)shellLink);
		shellLink->lpVtbl->Release(shellLink);
		
		shellLink = pidgin_win7_create_shell_link(_("Pr_eferences"), iconpath, 8, pidgin_path, "--protocolhandler=win7:open?window=prefs", NULL);
		shellLinks->lpVtbl->AddObject(shellLinks, (IUnknown *)shellLink);
		shellLink->lpVtbl->Release(shellLink);
		
		shellLink = pidgin_win7_create_shell_link(_("_Quit"), iconpath, 9, pidgin_path, "--protocolhandler=win7:quit", NULL);
		shellLinks->lpVtbl->AddObject(shellLinks, (IUnknown *)shellLink);
		shellLink->lpVtbl->Release(shellLink);
