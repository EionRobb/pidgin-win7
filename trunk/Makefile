...
WIN32_LIBS = -L${WIN32_DEV_DIR}/gtk_2_0/lib -L${WIN32_PIDGIN_DIR}/libpurple -L${WIN32_PIDGIN_DIR}/pidgin -lglib-2.0 -lgobject-2.0 -lgtk-win32-2.0 -lgdk-win32-2.0 -lintl -lws2_32 -lpurple -lole32 -L. -lpidgin -lgdk_pixbuf-2.0 -lgdk-win32-2.0 -lgdi32
